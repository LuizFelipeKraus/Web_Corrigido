...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{route('cadastrar_compra')}}" method="POST" class="mt-1 ">
                @csrf
                <img width="100"
                ...
                <h1 class="text-center">Cadastrar Compra</h1>
                <div class="input-group mb-1 pt-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Dia da Compra</span>
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="number" name="valor" min="0,01" placeholder="Valor" class="form-control"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="R$00,00"
                        id="f_valor">
                </div>
                <div class="input-group mb-1">
                    ...
                    <select class="custom-select" id="inputGroupSelect01" name="id_cliente" id="f_id_cliente">
                        @foreach($clientes as $k => $cli)
                        <option aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                            value="{{$cli->id}}">{{$cli->nome}}</option>
                        @endforeach
                    </select>
                </div>
