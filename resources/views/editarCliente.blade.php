...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-6">
            <form action="{{route('editar_cliente',['id'=> $clientesEditar->id])}}" method="POST" class="mt-1 pt-1">
                @csrf
                <img width="100"
                ...
                <h1 class="text-center">Editar Cadastro de Cliente</h1>
                <div class="input-group mb-1 pt-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Nome</span>
                    <input type="text" name="nome" placeholder="Nome" class="form-control"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                        value="{{$clientesEditar->nome}}" id="f_nome">
                </div>
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="endereco" max="120" min="0" placeholder="Endereco" class="form-control"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                        value="{{$clientesEditar->endereco}} " id="f_endereco">
                </div>
                <div class="input-group mb-1">
                    ...
                    <input type="number" name="cep" placeholder="Cep" class="form-control"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                        value="{{$clientesEditar->cep}}" id="f_cep">
                </div>
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="cidade" placeholder="Cidade" class="form-control"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                        value="{{$clientesEditar->cidade}}" id="f_cidade">
                </div>
                <div class="input-group mb-1">
                    ...
                    <select class="custom-select" id="inputGroupSelect01"  name="estado" 
                        value="{{$clientesEditar->estado}}" id="f_estado">

                        <option value="estado">{{$clientesEditar->estado}}</option>
